...
const std::string MICRO_PHONE_BLOCKED_CALLBACK_NAME = "microphoneBlocked";
...
public:
    ...
    void RemoveMicrophoneBlockedCallbackCb();
    int32_t GetRoutingMicrophoneBlockedCbListSize();
