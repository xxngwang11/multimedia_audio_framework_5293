...
class ProAudioServiceAdapterImpl : public AudioServiceAdapter, public AudioServiceHpaeCallback, public std::enable_shared_from_this<ProAudioServiceAdapterImpl> {
public:
