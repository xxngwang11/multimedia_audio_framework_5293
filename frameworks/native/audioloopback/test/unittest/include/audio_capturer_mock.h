...
public:
    ...
    MOCK_METHOD(void, SetAudioCapturerErrorCallback, (std::shared_ptr<AudioCapturerErrorCallback> errorCallback), (override));
    MOCK_METHOD(void, SetFastStatusChangeCallback, (const std::shared_ptr<AudioCapturerFastStatusChangeCallback> &callback), (override));
    ...
    MOCK_METHOD(int32_t, SetCapturerPositionCallback, (int64_t markPosition, const std::shared_ptr<CapturerPositionCallback> &callback), (override));
    MOCK_METHOD(void, UnsetCapturerPositionCallback, (), (override));
    MOCK_METHOD(int32_t, SetCapturerPeriodPositionCallback, (int64_t frameNumber, const std::shared_ptr<CapturerPeriodPositionCallback> &callback), (override));
    MOCK_METHOD(void, UnsetCapturerPeriodPositionCallback, (), (override));
    MOCK_METHOD(int32_t, RegisterAudioPolicyServerDiedCb, (const int32_t clientPid, const std::shared_ptr<AudioCapturerPolicyServiceDiedCallback> &callback), (override));
    ...
    MOCK_METHOD(int32_t, SetCapturerReadCallback, (const std::shared_ptr<AudioCapturerReadCallback> &callback), (override));
    ...
    MOCK_METHOD(int32_t, SetAudioCapturerDeviceChangeCallback, (const std::shared_ptr<AudioCapturerDeviceChangeCallback> &callback), (override));
    MOCK_METHOD(int32_t, RemoveAudioCapturerDeviceChangeCallback, (const std::shared_ptr<AudioCapturerDeviceChangeCallback> &callback), (override));
    MOCK_METHOD(int32_t, SetAudioCapturerInfoChangeCallback, (const std::shared_ptr<AudioCapturerInfoChangeCallback> &callback), (override));
    MOCK_METHOD(int32_t, RemoveAudioCapturerInfoChangeCallback, (const std::shared_ptr<AudioCapturerInfoChangeCallback> &callback), (override));
