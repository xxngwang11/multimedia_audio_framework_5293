...
static const std::unordered_map<std::string, AudioInputType> AudioCaptureSource::audioInputTypeMap_ = {
    ...
    {"AUDIO_INPUT_UPLINK_TYPE", AUDIO_INPUT_UPLINK_TYPE},
    {"AUDIO_INPUT_DOWNLINK_TYPE", AUDIO_INPUT_DOWNLINK_TYPE},
