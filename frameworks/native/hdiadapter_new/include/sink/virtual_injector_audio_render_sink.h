...
#ifndef VIRTUAL_INJECTOR_AUDIO_RENDER_SINK_H
#define VIRTUAL_INJECTOR_AUDIO_RENDER_SINK_H
...
class VirtualInjectorAudioRenderSink : public IAudioRenderSink {
public:
    VirtualInjectorAudioRenderSink() = default;
    ~VirtualInjectorAudioRenderSink();
...
#endif // VIRTUAL_INJECTOR_AUDIO_RENDER_SINK_H