...
const std::set<std::string> STREAM_USAGE_SET = {
    "STREAM_USAGE_UNKNOWN", "STREAM_USAGE_MEDIA", "STREAM_USAGE_MUSIC", "STREAM_USAGE_VOICE_COMMUNICATION",
    "STREAM_USAGE_VOICE_ASSISTANT", "STREAM_USAGE_VOICE_CALL_ASSISTANT", "STREAM_USAGE_ALARM",
    "STREAM_USAGE_VOICE_MESSAGE", "STREAM_USAGE_NOTIFICATION_RINGTONE", "STREAM_USAGE_RINGTONE",
    "STREAM_USAGE_NOTIFICATION", "STREAM_USAGE_ACCESSIBILITY", "STREAM_USAGE_SYSTEM",
    "STREAM_USAGE_MOVIE", "STREAM_USAGE_GAME", "STREAM_USAGE_AUDIOBOOK", "STREAM_USAGE_NAVIGATION",
    "STREAM_USAGE_DTMF", "STREAM_USAGE_ENFORCED_TONE", "STREAM_USAGE_ULTRASONIC", "STREAM_USAGE_VIDEO_COMMUNICATION",
...
const std::unordered_map<std::string, StreamUsage> STREAM_USAGE_MAP = {
    ...
    {STREAM_VOICE_MESSAGE, "STREAM_USAGE_ALARM"},
    // STREAM_USAGE_RINGTONE(6), STREAM_USAGE_NATIFICATION_RINGRONE(6) both mapped to STREAM_USAGE_RINGTONE
    {STREAM_USAGE_RINGTONE, "STREAM_USAGE_RINGTONE"},
    {STREAM_USAGE_NOTIFICATION, "STREAM_USAGE_RINGTONE"},
