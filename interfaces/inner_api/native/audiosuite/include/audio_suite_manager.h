...
public:
    ...
    virtual int32_t SetEquailizerMode(uint32_t nodeId, EqualizerMode eqMode);
    virtual int32_t SetEqualizerFrequencyBandGains(uint32_t nodeId, AudioEqualizerFrequencyBandGains gains);
    virtual int32_t SetSoundFiledType(uint32_t nodeId, SoundFieldType soundFieldType);
    virtual int32_t SetEnvironmentType(uint32_t nodeId, EnvironmentType enviromentType);
