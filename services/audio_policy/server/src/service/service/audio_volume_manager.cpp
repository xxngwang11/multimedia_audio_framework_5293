...
int32_t AudioVolumeManager::GetSystemVolumeLevel(AudioStreamType streamType) const
{
    {
    ...
    bool internalCall)
{
    ...
    bool mute;
    audioA2dpDevice_.GetA2dpDeviceMute(macAddress, mute);
    mute =  mute ? true : (sVolumeLevel == 0);
