...
#include "pa_adapter_manager_extend_unit_test.h"
...
void PaAdapterManagerExtUnitTest::SetUpTestCase(void) {}
void PaAdapterManagerExtUnitTest::TearDownTestCase(void) {}
void PaAdapterManagerExtUnitTest::SetUp(void) {}
void PaAdapterManagerExtUnitTest::TearDown(void) {}
...
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_001, TestSize.Level1)
{
#ifdef HAS_FEATURE_INNERCAPTURER
    LoadPaPort();
#endif
...
* @tc.desc   : Test CreateRender interface.
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_002, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
    adapterManager->InitPaContext();
...
* @tc.desc   : Test CreateRender interface.
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_003, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
    adapterManager->InitPaContext();
...
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_004, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
    adapterManager->InitPaContext();
...
* @tc.desc   : Test ReleaseRender interface.
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_005, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
    adapterManager->InitPaContext();
...
* @tc.desc   : Test ReleaseRender interface.
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_006, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
    adapterManager->InitPaContext();
...
* @tc.desc   : Test ReleaseRender interface.
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_007, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
    adapterManager->InitPaContext();
...
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_008, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
...
* @tc.desc   : Test StartRender interface.
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_009, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
    adapterManager->InitPaContext();
...
* @tc.desc   : Test StartRender interface.
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_010, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
...
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_011, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
    adapterManager->InitPaContext();
...
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_012, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
...
* @tc.desc   : Test PauseRender interface.
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_013, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
    adapterManager->InitPaContext();
...
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_014, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
...
* @tc.desc   : Test GetStreamCount interface.
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_015, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
...
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_016, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
    adapterManager->InitPaContext();
...
* @tc.desc   : Test CreateCapturer interface.
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_017, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
    adapterManager->InitPaContext();
...
* @tc.desc   : Test CreateCapturer interface.
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_018, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
    adapterManager->InitPaContext();
...
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_019, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
...
* @tc.desc   : Test ResetPaContext interface.
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_020, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
...
* @tc.desc   : Test ResetPaContext interface.
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_021, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
...
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_022, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
...
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_023, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
...
* @tc.desc   : Test GetDeviceNameForConnect interface.
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_024, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
...
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_025, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
    adapterManager->InitPaContext();
...
* @tc.desc   : Test ReleasePaStream interface.
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_026, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
    adapterManager->InitPaContext();
...
* @tc.desc   : Test ReleasePaStream interface.
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_027, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
...
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_035, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
...
* @tc.desc   : Test CheckHighResolution interface.
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_036, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
...
* @tc.desc   : Test CheckHighResolution interface.
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_037, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
...
* @tc.desc   : Test CheckHighResolution interface.
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_038, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
...
* @tc.desc   : Test CheckHighResolution interface.
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_039, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
...
* @tc.desc   : Test CheckHighResolution interface.
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_040, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
...
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_041, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
...
* @tc.desc   : Test SetHighResolution interface.
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_042, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
...
* @tc.desc   : Test SetHighResolution interface.
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_043, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
...
* @tc.desc   : Test SetHighResolution interface.
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_044, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
...
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_045, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
...
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_046, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
    adapterManager->InitPaContext();
...
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_047, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    adapterManager->InitPaContext();
    AudioProcessConfig processConfig = GetInnerCapConfig();
...
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_048, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    adapterManager->InitPaContext();
    AudioProcessConfig processConfig = GetInnerCapConfig();
...
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_049, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
...
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_050, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
...
* @tc.desc   : Test GetEnhanceSceneName interface.
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_051, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
...
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_053, TestSize.Level1)
{
    uint32_t streamIndex = 0;
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
...
* @tc.desc   : Test ReleaseCapturer interface.
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_054, TestSize.Level1)
{
...
* @tc.desc   : Test ReleaseCapturer interface.
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_055, TestSize.Level1)
{
    uint32_t streamIndex0 = 0;
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
...
* @tc.desc   : Test ResetPaContext interface.
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_056, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
...
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_057, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
...
* @tc.desc   : Test ConvertToPAAudioParams interface.
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_058, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
...
* @tc.desc   : Test ConvertToPAAudioParams interface.
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_059, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
    ASSERT_TRUE(adapterManager != nullptr);
...
* @tc.desc   : Test GetEnhanceSceneName interface.
*/
HWTEST(PaAdapterManagerExtUnitTest, PaAdapterManager_060, TestSize.Level1)
{
    PaAdapterManager *adapterManager = new PaAdapterManager(DUP_PLAYBACK);
