...
#ifndef LOG_TAGS
#define LOG_TAGS "ProAudioStreamManagerExtUnitTest"
#endif

#include "pro_audio_stream_manager_extend_unit_test.h"
...
void ProAudioStreamManagerExtUnitTest::SetUpTestCase(void) {}
void ProAudioStreamManagerExtUnitTest::TearDownTestCase(void) {}
void ProAudioStreamManagerExtUnitTest::SetUp(void) {}
void ProAudioStreamManagerExtUnitTest::TearDown(void) {}
...
*/
HWTEST(ProAudioStreamManagerExtUnitTest, ProAudioStreamManager_001, TestSize.Level1)
{
...
* @tc.desc   : Test CreateRender interface.
*/
HWTEST(ProAudioStreamManagerExtUnitTest, ProAudioStreamManager_002, TestSize.Level1)
{
    shared_ptr<ProAudioStreamManager> audioStreamManager = make_shared<ProAudioStreamManager>(DIRECT_PLAYBACK);
    ASSERT_TRUE(audioStreamManager != nullptr);
...
* @tc.desc   : Test CreateRender interface.
*/
HWTEST(ProAudioStreamManagerExtUnitTest, ProAudioStreamManager_003, TestSize.Level1)
{
    shared_ptr<ProAudioStreamManager> audioStreamManager = make_shared<ProAudioStreamManager>(DIRECT_PLAYBACK);
    ASSERT_TRUE(audioStreamManager != nullptr);
...
*/
HWTEST(ProAudioStreamManagerExtUnitTest, ProAudioStreamManager_004, TestSize.Level1)
{
    shared_ptr<ProAudioStreamManager> audioStreamManager = make_shared<ProAudioStreamManager>(DIRECT_PLAYBACK);
    ASSERT_TRUE(audioStreamManager != nullptr);
...
* @tc.desc   : Test ReleaseRender interface.
*/
HWTEST(ProAudioStreamManagerExtUnitTest, ProAudioStreamManager_005, TestSize.Level1)
{
    shared_ptr<ProAudioStreamManager> audioStreamManager = make_shared<ProAudioStreamManager>(DIRECT_PLAYBACK);
    ASSERT_TRUE(audioStreamManager != nullptr);
...
*/
HWTEST(ProAudioStreamManagerExtUnitTest, ProAudioStreamManager_006, TestSize.Level1)
{
    shared_ptr<ProAudioStreamManager> audioStreamManager = make_shared<ProAudioStreamManager>(DIRECT_PLAYBACK);
    ASSERT_TRUE(audioStreamManager != nullptr);
...
* @tc.desc   : Test ReleaseRender interface.
*/
HWTEST(ProAudioStreamManagerExtUnitTest, ProAudioStreamManager_007, TestSize.Level1)
{
    shared_ptr<ProAudioStreamManager> audioStreamManager = make_shared<ProAudioStreamManager>(DIRECT_PLAYBACK);
    ASSERT_TRUE(audioStreamManager != nullptr);
...
*/
HWTEST(ProAudioStreamManagerExtUnitTest, ProAudioStreamManager_008, TestSize.Level1)
{
    shared_ptr<ProAudioStreamManager> audioStreamManager = make_shared<ProAudioStreamManager>(DIRECT_PLAYBACK);
    ASSERT_TRUE(audioStreamManager != nullptr);
...
* @tc.desc   : Test StartRender interface.
*/
HWTEST(ProAudioStreamManagerExtUnitTest, ProAudioStreamManager_009, TestSize.Level1)
{
    shared_ptr<ProAudioStreamManager> audioStreamManager = make_shared<ProAudioStreamManager>(DIRECT_PLAYBACK);
    ASSERT_TRUE(audioStreamManager != nullptr);
...
* @tc.desc   : Test StartRender interface.
*/
HWTEST(ProAudioStreamManagerExtUnitTest, ProAudioStreamManager_010, TestSize.Level1)
{
    shared_ptr<ProAudioStreamManager> audioStreamManager = make_shared<ProAudioStreamManager>(DIRECT_PLAYBACK);
    ASSERT_TRUE(audioStreamManager != nullptr);
...
*/
HWTEST(ProAudioStreamManagerExtUnitTest, ProAudioStreamManager_011, TestSize.Level1)
{
    shared_ptr<ProAudioStreamManager> audioStreamManager = make_shared<ProAudioStreamManager>(DIRECT_PLAYBACK);
    ASSERT_TRUE(audioStreamManager != nullptr);
...
* @tc.desc   : Test StopRender interface.
*/
HWTEST(ProAudioStreamManagerExtUnitTest, ProAudioStreamManager_012, TestSize.Level1)
{
    shared_ptr<ProAudioStreamManager> audioStreamManager = make_shared<ProAudioStreamManager>(DIRECT_PLAYBACK);
    ASSERT_TRUE(audioStreamManager != nullptr);
...
* @tc.desc   : Test StopRender interface.
*/
HWTEST(ProAudioStreamManagerExtUnitTest, ProAudioStreamManager_013, TestSize.Level1)
{
    shared_ptr<ProAudioStreamManager> audioStreamManager = make_shared<ProAudioStreamManager>(DIRECT_PLAYBACK);
    ASSERT_TRUE(audioStreamManager != nullptr);
...
*/
HWTEST(ProAudioStreamManagerExtUnitTest, ProAudioStreamManager_014, TestSize.Level1)
{
    shared_ptr<ProAudioStreamManager> audioStreamManager = make_shared<ProAudioStreamManager>(DIRECT_PLAYBACK);
    ASSERT_TRUE(audioStreamManager != nullptr);
...
* @tc.desc   : Test PauseRender interface.
*/
HWTEST(ProAudioStreamManagerExtUnitTest, ProAudioStreamManager_015, TestSize.Level1)
{
    shared_ptr<ProAudioStreamManager> audioStreamManager = make_shared<ProAudioStreamManager>(DIRECT_PLAYBACK);
    ASSERT_TRUE(audioStreamManager != nullptr);
...
* @tc.desc   : Test PauseRender interface.
*/
HWTEST(ProAudioStreamManagerExtUnitTest, ProAudioStreamManager_016, TestSize.Level1)
{
    shared_ptr<ProAudioStreamManager> audioStreamManager = make_shared<ProAudioStreamManager>(DIRECT_PLAYBACK);
    ASSERT_TRUE(audioStreamManager != nullptr);
...
*/
HWTEST(ProAudioStreamManagerExtUnitTest, ProAudioStreamManager_017, TestSize.Level1)
{
    shared_ptr<ProAudioStreamManager> audioStreamManager = make_shared<ProAudioStreamManager>(DIRECT_PLAYBACK);
    ASSERT_TRUE(audioStreamManager != nullptr);
...
*/
HWTEST(ProAudioStreamManagerExtUnitTest, ProAudioStreamManager_018, TestSize.Level1)
{
    shared_ptr<ProAudioStreamManager> audioStreamManager = make_shared<ProAudioStreamManager>(DIRECT_PLAYBACK);
    ASSERT_TRUE(audioStreamManager != nullptr);
...
*/
HWTEST(ProAudioStreamManagerExtUnitTest, ProAudioStreamManager_019, TestSize.Level1)
{
    shared_ptr<ProAudioStreamManager> audioStreamManager = make_shared<ProAudioStreamManager>(DIRECT_PLAYBACK);
    ASSERT_TRUE(audioStreamManager != nullptr);
...
*/
HWTEST(ProAudioStreamManagerExtUnitTest, ProAudioStreamManager_020, TestSize.Level1)
{
    shared_ptr<ProAudioStreamManager> audioStreamManager = make_shared<ProAudioStreamManager>(DIRECT_PLAYBACK);
    ASSERT_TRUE(audioStreamManager != nullptr);
...
*/
HWTEST(ProAudioStreamManagerExtUnitTest, ProAudioStreamManager_021, TestSize.Level1)
{
    shared_ptr<ProAudioStreamManager> audioStreamManager = make_shared<ProAudioStreamManager>(DIRECT_PLAYBACK);
    ASSERT_TRUE(audioStreamManager != nullptr);
...
* @tc.desc   : Test TriggerStartIfNecessary interface.
*/
HWTEST(ProAudioStreamManagerExtUnitTest, ProAudioStreamManager_022, TestSize.Level1)
{
    shared_ptr<ProAudioStreamManager> audioStreamManager = make_shared<ProAudioStreamManager>(DIRECT_PLAYBACK);
    ASSERT_TRUE(audioStreamManager != nullptr);
...
*/
HWTEST(ProAudioStreamManagerExtUnitTest, CreateRendererStream_001, TestSize.Level1)
{
    shared_ptr<ProAudioStreamManager> audioStreamManager = make_shared<ProAudioStreamManager>(DIRECT_PLAYBACK);
    ASSERT_TRUE(audioStreamManager != nullptr);
    AudioProcessConfig config;
...
* @tc.desc   : Test ReleaseRender interface.
*/
HWTEST(ProAudioStreamManagerExtUnitTest, ReleaseRender_001, TestSize.Level1)
{
    shared_ptr<ProAudioStreamManager> audioStreamManager = make_shared<ProAudioStreamManager>(DIRECT_PLAYBACK);
    ASSERT_TRUE(audioStreamManager != nullptr);
