...
class PolicyProviderStubExtUnitTest : public ::testing::Test {
public:
    void SetUp();
    void TearDown();
};

void PolicyProviderStubExtUnitTest::SetUp(void)
{
    // input testcase setup step，setup invoked before each testcases
}

void PolicyProviderStubExtUnitTest::TearDown(void)
{
 ...
 */
HWTEST_F(PolicyProviderStubExtUnitTest, PolicyProviderStub_001, TestSize.Level1)
{
 ...
 * @tc.desc  : Test PolicyProviderStub::OnRemoteRequest().
 */
HWTEST_F(PolicyProviderStubExtUnitTest, PolicyProviderStub_002, TestSize.Level1)
{
    MockPolicyProvider mockProvider;
    auto policyProviderStub = std::make_shared<PolicyProviderWrapper>(&mockProvider);
    EXPECT_NE(policyProviderStub, nullptr);
 ...
 * @tc.desc  : Test PolicyProviderStub::OnRemoteRequest().
 */
HWTEST_F(PolicyProviderStubExtUnitTest, PolicyProviderStub_003, TestSize.Level1)
{
    MockPolicyProvider mockProvider;
    auto policyProviderStub = std::make_shared<PolicyProviderWrapper>(&mockProvider);
    EXPECT_NE(policyProviderStub, nullptr);
 ...
 * @tc.desc  : Test PolicyProviderStub::OnRemoteRequest().
 */
HWTEST_F(PolicyProviderStubExtUnitTest, PolicyProviderStub_004, TestSize.Level1)
{
    MockPolicyProvider mockProvider;
    auto policyProviderStub = std::make_shared<PolicyProviderWrapper>(&mockProvider);
    EXPECT_NE(policyProviderStub, nullptr);
 ...
 * @tc.desc  : Test PolicyProviderStub::OnRemoteRequest().
 */
HWTEST_F(PolicyProviderStubExtUnitTest, PolicyProviderStub_005, TestSize.Level1)
{
    MockPolicyProvider mockProvider;
    auto policyProviderStub = std::make_shared<PolicyProviderWrapper>(&mockProvider);
    EXPECT_NE(policyProviderStub, nullptr);
 ...
 * @tc.desc  : Test PolicyProviderStub::OnRemoteRequest().
 */
HWTEST_F(PolicyProviderStubExtUnitTest, PolicyProviderStub_006, TestSize.Level1)
{
    MockPolicyProvider mockProvider;
    auto policyProviderStub = std::make_shared<PolicyProviderWrapper>(&mockProvider);
    EXPECT_NE(policyProviderStub, nullptr);
 ...
 * @tc.desc  : Test PolicyProviderStub::OnRemoteRequest().
 */
HWTEST_F(PolicyProviderStubExtUnitTest, PolicyProviderStub_007, TestSize.Level1)
{
    MockPolicyProvider mockProvider;
    auto policyProviderStub = std::make_shared<PolicyProviderWrapper>(&mockProvider);
    EXPECT_NE(policyProviderStub, nullptr);
 ...
 * @tc.desc  : Test PolicyProviderStub::OnRemoteRequest().
 */
HWTEST_F(PolicyProviderStubExtUnitTest, PolicyProviderStub_008, TestSize.Level1)
{
    MockPolicyProvider mockProvider;
    auto policyProviderStub = std::make_shared<PolicyProviderWrapper>(&mockProvider);
    EXPECT_NE(policyProviderStub, nullptr);
 ...
 * @tc.desc  : Test PolicyProviderStub::OnRemoteRequest().
 */
HWTEST_F(PolicyProviderStubExtUnitTest, PolicyProviderStub_009, TestSize.Level1)
{
    MockPolicyProvider mockProvider;
    auto policyProviderStub = std::make_shared<PolicyProviderWrapper>(&mockProvider);
    EXPECT_NE(policyProviderStub, nullptr);
 ...
 * @tc.desc  : Test PolicyProviderStub::OnRemoteRequest().
 */
HWTEST_F(PolicyProviderStubExtUnitTest, PolicyProviderStub_010, TestSize.Level1)
{
    MockPolicyProvider mockProvider;
    auto policyProviderStub = std::make_shared<PolicyProviderWrapper>(&mockProvider);
    EXPECT_NE(policyProviderStub, nullptr);
 ...
 * @tc.desc  : Test PolicyProviderStub::OnRemoteRequest().
 */
HWTEST_F(PolicyProviderStubExtUnitTest, PolicyProviderStub_011, TestSize.Level1)
{
    MockPolicyProvider mockProvider;
    auto policyProviderStub = std::make_shared<PolicyProviderWrapper>(&mockProvider);
    EXPECT_NE(policyProviderStub, nullptr);
 ...
 * @tc.desc  : Test PolicyProviderStub::OnRemoteRequest().
 */
HWTEST_F(PolicyProviderStubExtUnitTest, PolicyProviderStub_012, TestSize.Level1)
{
    MockPolicyProvider mockProvider;
    auto policyProviderStub = std::make_shared<PolicyProviderWrapper>(&mockProvider);
    EXPECT_NE(policyProviderStub, nullptr);
 ...
 * @tc.desc  : Test PolicyProviderStub::OnRemoteRequest().
 */
HWTEST_F(PolicyProviderStubExtUnitTest, PolicyProviderStub_013, TestSize.Level1)
{
    MockPolicyProvider mockProvider;
    auto policyProviderStub = std::make_shared<PolicyProviderWrapper>(&mockProvider);
    EXPECT_NE(policyProviderStub, nullptr);
 ...
 * @tc.desc  : Test PolicyProviderStub::OnRemoteRequest().
 */
HWTEST_F(PolicyProviderStubExtUnitTest, PolicyProviderStub_014, TestSize.Level1)
{
    MockPolicyProvider mockProvider;
    auto policyProviderStub = std::make_shared<PolicyProviderWrapper>(&mockProvider);
    EXPECT_NE(policyProviderStub, nullptr);
 ...
 * @tc.desc  : Test PolicyProviderStub::OnRemoteRequest().
 */
HWTEST_F(PolicyProviderStubExtUnitTest, PolicyProviderStub_015, TestSize.Level1)
{
    MockPolicyProvider mockProvider;
    auto policyProviderStub = std::make_shared<PolicyProviderWrapper>(&mockProvider);
    EXPECT_NE(policyProviderStub, nullptr);
 ...
 * @tc.desc  : Test PolicyProviderStub::OnRemoteRequest().
 */
HWTEST_F(PolicyProviderStubExtUnitTest, PolicyProviderStub_016, TestSize.Level1)
{
    MockPolicyProvider mockProvider;
    auto policyProviderStub = std::make_shared<PolicyProviderWrapper>(&mockProvider);
    EXPECT_NE(policyProviderStub, nullptr);
 ...
 */
HWTEST_F(PolicyProviderStubExtUnitTest, PolicyProviderStub_017, TestSize.Level1)
{
    MockPolicyProvider mockProvider;
    auto policyProviderStub = std::make_shared<PolicyProviderWrapper>(&mockProvider);
    EXPECT_NE(policyProviderStub, nullptr);
