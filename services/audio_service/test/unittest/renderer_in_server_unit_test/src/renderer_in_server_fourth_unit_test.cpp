...
#include "renderer_in_server_fourth_unit_test.h"
...
void RendererInServerFourthUnitTest::SetUpTestCase(void) {}

void RendererInServerFourthUnitTest::TearDownTestCase(void)
{
    stateListener.reset();
...
void RendererInServerFourthUnitTest::SetUp(void)
{
...
void RendererInServerFourthUnitTest::TearDown(void) {}
...
std::shared_ptr<IRendererStream> RendererInServerFourthUnitTest::CreateHpaeRendererStream()
{
 ...
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerStandByCheck_001, TestSize.Level1)
{
 ...
 * @tc.desc  : Test StandByCheck API.
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerStandByCheck_002, TestSize.Level1)
{
    AudioProcessConfig processConfig;
    processConfig.rendererInfo.streamUsage = StreamUsage::STREAM_USAGE_GAME;
    auto server = std::make_shared<RendererInServer>(processConfig, stateListener);
 ...
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerVolumeHandle_001, TestSize.Level1)
{
    AudioProcessConfig processConfig;
    processConfig.rendererInfo.streamUsage = StreamUsage::STREAM_USAGE_GAME;
    auto server = std::make_shared<RendererInServer>(processConfig, stateListener);
 ...
 */
HWTEST_F(RendererInServerFourthUnitTest, InnerCaptureOtherStream_001, TestSize.Level1)
{
    AudioProcessConfig processConfig;
    processConfig.rendererInfo.streamUsage = StreamUsage::STREAM_USAGE_GAME;
    auto server = std::make_shared<RendererInServer>(processConfig, stateListener);
 ...
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerUpdateWriteIndex_001, TestSize.Level1)
{
    AudioProcessConfig processConfig;
    processConfig.rendererInfo.streamUsage = StreamUsage::STREAM_USAGE_GAME;
    auto server = std::make_shared<RendererInServer>(processConfig, stateListener);
 ...
 * @tc.desc  : Test UpdateWriteIndex interface.
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerUpdateWriteIndex_002, TestSize.Level1)
{
    AudioProcessConfig processConfig;
    processConfig.rendererInfo.streamUsage = StreamUsage::STREAM_USAGE_GAME;
    auto server = std::make_shared<RendererInServer>(processConfig, stateListener);
 ...
 * @tc.desc  : Test Start.
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerStart_001, TestSize.Level1)
{
 ...
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerdualToneStreamInStart_001, TestSize.Level1)
{
    AudioProcessConfig processConfig;
 ...
 * @tc.desc  : Test dualToneStreamInStart interface.
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerdualToneStreamInStart_002, TestSize.Level1)
{
    AudioProcessConfig processConfig;
    processConfig.rendererInfo.streamUsage = StreamUsage::STREAM_USAGE_ULTRASONIC;
    auto server = std::make_shared<RendererInServer>(processConfig, stateListener);
 ...
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerPause_001, TestSize.Level1)
{
    AudioBufferHolder bufferHolder;
    uint32_t totalSizeInFrame = 10;
    uint32_t byteSizePerFrame = 10;
 ...
 * @tc.desc  : Test Pause interface.
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerPause_002, TestSize.Level1)
{
    AudioBufferHolder bufferHolder;
    uint32_t totalSizeInFrame = 10;
    uint32_t byteSizePerFrame = 10;
 ...
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerRelease_001, TestSize.Level1)
{
    AudioProcessConfig processConfig;
 ...
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerSetLowPowerVolume_001, TestSize.Level1)
{
    AudioProcessConfig processConfig;
    processConfig.audioMode = AUDIO_MODE_RECORD;
    processConfig.rendererInfo.streamUsage = StreamUsage::STREAM_USAGE_ULTRASONIC;
 ...
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerDisableInnerCap_001, TestSize.Level1)
{
    AudioProcessConfig processConfig;
    processConfig.rendererInfo.streamUsage = StreamUsage::STREAM_USAGE_ULTRASONIC;
    auto server = std::make_shared<RendererInServer>(processConfig, stateListener);
 ...
 * @tc.desc  : Test DisableInnerCap interface.
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerDisableInnerCap_002, TestSize.Level1)
{
    AudioProcessConfig processConfig;
    processConfig.rendererInfo.streamUsage = StreamUsage::STREAM_USAGE_ULTRASONIC;
 ...
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerSetOffloadMode_001, TestSize.Level1)
{
    AudioProcessConfig processConfig;
    processConfig.rendererInfo.streamUsage = StreamUsage::STREAM_USAGE_ULTRASONIC;
    auto server = std::make_shared<RendererInServer>(processConfig, stateListener);
 ...
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerOffloadSetVolumeInner_001, TestSize.Level1)
{
    AudioProcessConfig processConfig;
    processConfig.rendererInfo.streamUsage = StreamUsage::STREAM_USAGE_ULTRASONIC;
    auto server = std::make_shared<RendererInServer>(processConfig, stateListener);
 ...
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerIsHighResolution_001, TestSize.Level1)
{
    AudioProcessConfig processConfig;
    processConfig.deviceType = DEVICE_TYPE_WIRED_HEADSET;
    processConfig.streamType = STREAM_MUSIC;
 ...
 * @tc.desc  : Test IsHighResolution interface.
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerIsHighResolution_002, TestSize.Level1)
{
    AudioProcessConfig processConfig;
    processConfig.deviceType = DEVICE_TYPE_WIRED_HEADSET;
    processConfig.streamType = STREAM_MUSIC;
 ...
 * @tc.desc  : Test IsHighResolution interface.
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerIsHighResolution_003, TestSize.Level1)
{
    int rate = 193000;
    AudioProcessConfig processConfig;
    processConfig.deviceType = DEVICE_TYPE_WIRED_HEADSET;
 ...
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerSetSilentModeAndMixWithOthers_001, TestSize.Level1)
{
    AudioProcessConfig processConfig;
    processConfig.rendererInfo.streamUsage = StreamUsage::STREAM_USAGE_ULTRASONIC;
    auto server = std::make_shared<RendererInServer>(processConfig, stateListener);
 ...
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerSetClientVolume_001, TestSize.Level1)
{
    AudioProcessConfig processConfig;
    processConfig.rendererInfo.streamUsage = StreamUsage::STREAM_USAGE_ULTRASONIC;
    auto server = std::make_shared<RendererInServer>(processConfig, stateListener);
 ...
 * @tc.desc  : Test SetClientVolume interface.
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerSetClientVolume_002, TestSize.Level1)
{
    AudioProcessConfig processConfig;
    processConfig.rendererInfo.streamUsage = StreamUsage::STREAM_USAGE_ULTRASONIC;
    auto server = std::make_shared<RendererInServer>(processConfig, stateListener);
 ...
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerSetSetMute_001, TestSize.Level1)
{
    AudioProcessConfig processConfig;
    processConfig.rendererInfo.streamUsage = StreamUsage::STREAM_USAGE_ULTRASONIC;
    auto server = std::make_shared<RendererInServer>(processConfig, stateListener);
 ...
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerSetDuckFactor_001, TestSize.Level1)
{
    AudioProcessConfig processConfig;
    processConfig.rendererInfo.streamUsage = StreamUsage::STREAM_USAGE_ULTRASONIC;
    auto server = std::make_shared<RendererInServer>(processConfig, stateListener);
 ...
 * @tc.desc  : Test SetDuckFactor interface.
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerSetDuckFactor_002, TestSize.Level1)
{
    AudioProcessConfig processConfig;
    processConfig.rendererInfo.streamUsage = StreamUsage::STREAM_USAGE_ULTRASONIC;
    auto server = std::make_shared<RendererInServer>(processConfig, stateListener);
 ...
 * @tc.desc  : Test SetDuckFactor interface.
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerSetSetNonInterruptMute_001, TestSize.Level1)
{
    AudioProcessConfig processConfig;
    processConfig.rendererInfo.streamUsage = StreamUsage::STREAM_USAGE_ULTRASONIC;
    auto server = std::make_shared<RendererInServer>(processConfig, stateListener);
 ...
 * @tc.desc  : Test SetDuckFactor interface.
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerRestoreSession_001, TestSize.Level1)
{
    AudioProcessConfig processConfig;
    processConfig.rendererInfo.streamUsage = StreamUsage::STREAM_USAGE_ULTRASONIC;
    auto server = std::make_shared<RendererInServer>(processConfig, stateListener);
 ...
 */
HWTEST_F(RendererInServerFourthUnitTest, RemoveIdForInjector_001, TestSize.Level1)
{
    AudioProcessConfig processConfig;
    processConfig.rendererInfo.streamUsage = StreamUsage::STREAM_USAGE_ULTRASONIC;
    auto server = std::make_shared<RendererInServer>(processConfig, stateListener);
 ...
 * @tc.desc  : Test RemoveIdForInjector interface.
 */
HWTEST_F(RendererInServerFourthUnitTest, RemoveIdForInjector_002, TestSize.Level1)
{
    AudioProcessConfig processConfig;
    processConfig.rendererInfo.streamUsage = StreamUsage::STREAM_USAGE_ULTRASONIC;
    auto server = std::make_shared<RendererInServer>(processConfig, stateListener);
 ...
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerWriteMuteDataSysEvent_001, TestSize.Level4)
{
 ...
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerWriteMuteDataSysEvent_002, TestSize.Level4)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_INVALID, SAMPLE_S24LE, MONO,
        AudioChannelLayout::CH_LAYOUT_UNKNOWN);
    InitAudioProcessConfig(testStreamInfo);
 ...
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerWriteMuteDataSysEvent_003, TestSize.Level4)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_INVALID, SAMPLE_S24LE, MONO,
        AudioChannelLayout::CH_LAYOUT_UNKNOWN);
    InitAudioProcessConfig(testStreamInfo);
 ...
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerWriteMuteDataSysEvent_004, TestSize.Level4)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_INVALID, SAMPLE_S24LE, MONO,
        AudioChannelLayout::CH_LAYOUT_UNKNOWN);
    InitAudioProcessConfig(testStreamInfo);
 ...
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerWriteMuteDataSysEvent_005, TestSize.Level4)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_INVALID, SAMPLE_S24LE, MONO,
        AudioChannelLayout::CH_LAYOUT_UNKNOWN);
    InitAudioProcessConfig(testStreamInfo);
 ...
 * @tc.desc  : Test WriteMuteDataSysEvent when buffer[0] is not 0 and startMuteTime_ is not 0 and isInSilentState_ is 0.
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerWriteMuteDataSysEvent_006, TestSize.Level4)
{
...
*/
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerWriteMuteDataSysEvent_007, TestSize.Level4)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_INVALID, SAMPLE_S24LE, MONO,
        AudioChannelLayout::CH_LAYOUT_UNKNOWN);
    InitAudioProcessConfig(testStreamInfo);
 ...
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerGetAudioTime_004, TestSize.Level1)
{
 ...
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerSetLowPowerVolume_004, TestSize.Level1)
{
    EXPECT_NE(nullptr, rendererInServer);
 ...
 * @tc.desc  : Test SetLowPowerVolume interface.
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerSetLowPowerVolume_005, TestSize.Level1)
{
 ...
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerOnWriteData_003, TestSize.Level1)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_INVALID, SAMPLE_S24LE, MONO,
        AudioChannelLayout::CH_LAYOUT_UNKNOWN);
...
*/
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerOnWriteData_004, TestSize.Level1)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_INVALID, SAMPLE_S24LE, MONO,
        AudioChannelLayout::CH_LAYOUT_UNKNOWN);
    InitAudioProcessConfig(testStreamInfo, DEVICE_TYPE_USB_HEADSET, AUDIO_FLAG_VOIP_DIRECT);
...
* currentReadFrame + requestDataInFrame > currentWriteFrame, offloadEnable_ is true.
*/
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerOnWriteData_005, TestSize.Level1)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_INVALID, SAMPLE_S24LE, MONO,
        AudioChannelLayout::CH_LAYOUT_UNKNOWN);
    InitAudioProcessConfig(testStreamInfo, DEVICE_TYPE_USB_HEADSET, AUDIO_FLAG_VOIP_DIRECT);
...
* currentReadFrame + requestDataInFrame > currentWriteFrame, offloadEnable_ is false.
*/
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerOnWriteData_006, TestSize.Level1)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_INVALID, SAMPLE_S24LE, MONO,
        AudioChannelLayout::CH_LAYOUT_UNKNOWN);
    InitAudioProcessConfig(testStreamInfo, DEVICE_TYPE_USB_HEADSET, AUDIO_FLAG_VOIP_DIRECT);
...
* currentReadFrame + requestDataInFrame <= currentWriteFrame, offloadEnable_ is false.
*/
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerOnWriteData_007, TestSize.Level1)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_INVALID, SAMPLE_S24LE, MONO,
        AudioChannelLayout::CH_LAYOUT_UNKNOWN);
    InitAudioProcessConfig(testStreamInfo, DEVICE_TYPE_USB_HEADSET, AUDIO_FLAG_VOIP_DIRECT);
...
*/
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerOnWriteData_008, TestSize.Level1)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_INVALID, SAMPLE_S24LE, MONO,
        AudioChannelLayout::CH_LAYOUT_UNKNOWN);
    InitAudioProcessConfig(testStreamInfo, DEVICE_TYPE_USB_HEADSET, AUDIO_FLAG_VOIP_DIRECT);
 ...
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerSetAudioHapticsSyncId_001, TestSize.Level1)
{
    AudioProcessConfig processConfig;
    processConfig.rendererInfo.streamUsage = StreamUsage::STREAM_USAGE_ULTRASONIC;
    auto server = std::make_shared<RendererInServer>(processConfig, stateListener);
 ...
 */
HWTEST_F(RendererInServerFourthUnitTest, IsHighResolution_001, TestSize.Level1)
{
 ...
 * @tc.desc  : Test IsHighResolution API
 */
HWTEST_F(RendererInServerFourthUnitTest, IsHighResolution_002, TestSize.Level1)
{
    AudioProcessConfig tempProcessConfig;
    tempProcessConfig.streamInfo = testStreamInfo;
 ...
 * @tc.desc  : Test IsHighResolution API
 */
HWTEST_F(RendererInServerFourthUnitTest, IsHighResolution_003, TestSize.Level1)
{
    AudioProcessConfig tempProcessConfig;
    tempProcessConfig.streamInfo = testStreamInfo;
    tempProcessConfig.streamType = STREAM_MUSIC;
 ...
 * @tc.desc  : Test IsHighResolution API
 */
HWTEST_F(RendererInServerFourthUnitTest, IsHighResolution_004, TestSize.Level1)
{
    AudioProcessConfig tempProcessConfig;
    tempProcessConfig.streamInfo = testStreamInfo;
    tempProcessConfig.streamType = STREAM_MUSIC;
 ...
 * @tc.desc  : Test IsHighResolution API
 */
HWTEST_F(RendererInServerFourthUnitTest, IsHighResolution_005, TestSize.Level1)
{
    AudioProcessConfig tempProcessConfig;
    tempProcessConfig.streamInfo = testStreamInfo;
    tempProcessConfig.streamType = STREAM_MUSIC;
...
 * @tc.desc  : Test IsHighResolution API
 */
HWTEST_F(RendererInServerFourthUnitTest, IsHighResolution_006, TestSize.Level1)
{
    AudioProcessConfig tempProcessConfig;
    tempProcessConfig.streamInfo = testStreamInfo;
    tempProcessConfig.streamType = STREAM_MUSIC;
 ...
 */
HWTEST_F(RendererInServerFourthUnitTest, GetPlaybackManager_001, TestSize.Level1)
{
 ...
 * @tc.desc  : Test GetPlaybackManager API
 */
HWTEST_F(RendererInServerFourthUnitTest, GetPlaybackManager_002, TestSize.Level1)
{
 ...
 * @tc.desc  : Test GetPlaybackManager API
 */
HWTEST_F(RendererInServerFourthUnitTest, GetPlaybackManager_003, TestSize.Level1)
{
 ...
 * @tc.desc  : Test Pause interface.
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerPause_003, TestSize.Level1)
{
    processConfig.streamType = STREAM_MOVIE;
    processConfig.rendererInfo.streamUsage = StreamUsage::STREAM_USAGE_ULTRASONIC;
    processConfig.rendererInfo.originalFlag = AUDIO_FLAG_PCM_OFFLOAD;
 ...
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerStopInner_001, TestSize.Level1)
{
    processConfig.streamType = STREAM_MOVIE;
    processConfig.rendererInfo.streamUsage = StreamUsage::STREAM_USAGE_ULTRASONIC;
    processConfig.rendererInfo.originalFlag = AUDIO_FLAG_PCM_OFFLOAD;
 ...
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerEnableInnerCap_001, TestSize.Level1)
{
    processConfig.streamType = STREAM_MOVIE;
    processConfig.rendererInfo.streamUsage = StreamUsage::STREAM_USAGE_ULTRASONIC;
    processConfig.rendererInfo.originalFlag = AUDIO_FLAG_PCM_OFFLOAD;
 ...
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerDisableInnerCapHandle_001, TestSize.Level1)
{
    processConfig.streamType = STREAM_MOVIE;
    processConfig.rendererInfo.streamUsage = StreamUsage::STREAM_USAGE_ULTRASONIC;
    processConfig.rendererInfo.originalFlag = AUDIO_FLAG_PCM_OFFLOAD;
 ...
 * @tc.desc  : Test SetOffloadMode interface.
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerSetOffloadMode_002, TestSize.Level1)
{
    AudioProcessConfig processConfig;
    processConfig.streamType = STREAM_MOVIE;
    processConfig.rendererInfo.streamUsage = StreamUsage::STREAM_USAGE_ULTRASONIC;
 ...
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerUnsetOffloadMode_001, TestSize.Level1)
{
    AudioProcessConfig processConfig;
    processConfig.streamType = STREAM_MOVIE;
    processConfig.rendererInfo.streamUsage = StreamUsage::STREAM_USAGE_ULTRASONIC;
 ...
 */
HWTEST_F(RendererInServerFourthUnitTest, RendererInServerSetLoudnessGain_001, TestSize.Level1)
{
    AudioProcessConfig processConfig;
    processConfig.streamType = STREAM_MOVIE;
    processConfig.rendererInfo.streamUsage = StreamUsage::STREAM_USAGE_ULTRASONIC;
