 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, GetVolume_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, SetVolume_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream;
    fastAudioStream = std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, SetSilentModeAndMixWithOthers_001, TestSize.Level1)
{
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, GetSwitchInfo_001, TestSize.Level4)
{
 ...
 * @tc.desc  : Test GetSwitchInfo interface.
 */
HWTEST_F(FastSystemStreamExtUnitTest, GetSwitchInfo_002, TestSize.Level1)
{
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, UpdatePlaybackCaptureConfig_001, TestSize.Level1)
{
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, GetAudioPipeType_001, TestSize.Level1)
{
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, GetFastStatus_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream;
    fastAudioStream = std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, SetMute_001, TestSize.Level1)
{
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, SetRenderMode_001, TestSize.Level1)
{
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, GetCaptureMode_001, TestSize.Level1)
{
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, SetLowPowerVolume_001, TestSize.Level1)
{
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, SetOffloadMode_001, TestSize.Level1)
{
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, SetAudioEffectMode_001, TestSize.Level1)
{
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, GetFramesWritten_001, TestSize.Level1)
{
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, SetSpeed_001, TestSize.Level1)
{
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, SetPitch_001, TestSize.Level1)
{
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, FlushAudioStream_001, TestSize.Level1)
{
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, SetAndGetCallback_001, TestSize.Level1)
{
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, SetAudioStreamInfo_001, TestSize.Level1)
{
 ...
 * @tc.desc  : Test SetAudioStreamInfo interface.
 */
HWTEST_F(FastSystemStreamExtUnitTest, SetAudioStreamInfo_002, TestSize.Level1)
{
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, RestoreAudioStream_001, TestSize.Level1)
{
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, InitializeAudioProcessConfig_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream;
    fastAudioStream = std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 * @tc.desc  : Test InitializeAudioProcessConfig interface.
 */
HWTEST_F(FastSystemStreamExtUnitTest, InitializeAudioProcessConfig_002, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream;
    fastAudioStream = std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, GetState_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream;
    fastAudioStream = std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, GetAudioPosition_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream;
    fastAudioStream = std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, SetRendererFirstFrameWritingCallback_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream;
    fastAudioStream = std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, SetPreferredFrameSize_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream;
    fastAudioStream = std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, UpdateLatencyTimestamp_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream;
    fastAudioStream = std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, Read_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream;
    fastAudioStream = std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, Write_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream;
    fastAudioStream = std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, SetUnderflowCount_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream;
    fastAudioStream = std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, SetOverflowCount_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream;
    fastAudioStream = std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, SetBufferSizeInMsec_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream;
    fastAudioStream = std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, SetInnerCapturerState_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream;
    fastAudioStream = std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, SetWakeupCapturerState_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream;
    fastAudioStream = std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, OnFirstFrameWriting_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream;
    fastAudioStream = std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, OnHandleData_001, TestSize.Level1)
{
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, ResetFirstFrameState_001, TestSize.Level1)
{
    std::shared_ptr<AudioRendererWriteCallback> callback = std::make_shared<AudioRendererWriteCallbackTest>();
    AudioStreamParams tempParams = {};
    auto audioStream = IAudioStream::GetRecordStream(IAudioStream::PA_STREAM, tempParams, STREAM_MUSIC, getpid());
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, ResetFirstFrameState_002, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream =
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, GetRendererWriteCallback_001, TestSize.Level1)
{
    std::shared_ptr<AudioRendererWriteCallback> callback = std::make_shared<AudioRendererWriteCallbackTest>();
    AudioStreamParams tempParams = {};
    auto audioStream = IAudioStream::GetRecordStream(IAudioStream::PA_STREAM, tempParams, STREAM_MUSIC, getpid());
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, GetCapturerReadCallback_001, TestSize.Level1)
{
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, SetChannelBlendMode_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream;
    fastAudioStream = std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, SetVolumeWithRamp_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream;
    fastAudioStream = std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, GetOffloadEnable_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream;
    fastAudioStream = std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, GetSpatializationEnabled_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream;
    fastAudioStream = std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, GetHighResolutionEnabled_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream;
    fastAudioStream = std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, SetDefaultOutputDevice_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream;
    fastAudioStream = std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, GetAudioTimestampInfo_001, TestSize.Level0)
{
    Timestamp timestamp;
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, GetAudioTimestampInfo_002, TestSize.Level0)
{
    Timestamp timestamp;
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, GetAudioTimestampInfo_003, TestSize.Level0)
{
    Timestamp timestamp;
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, GetAudioTimestampInfo_004, TestSize.Level0)
{
    Timestamp timestamp;
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, SetSwitchingStatus_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream;
    fastAudioStream = std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 * @tc.desc  : Test SetSwitchingStatus interface.
 */
HWTEST_F(FastSystemStreamExtUnitTest, SetSwitchingStatus_002, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream;
    fastAudioStream = std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, InitCallbackHandler_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream =
        std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, SafeSendCallbackEvent_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream =
        std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, HandleStateChangeEvent_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream =
        std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, ParamsToStateCmdType_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream =
        std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, SetSourceDuration_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream;
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, SetStreamCallback_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream =
        std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, GetAudioStreamInfo_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, GetAudioSessionID_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    auto fastAudioStream =
        std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, GetAudioTime_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, GetBufferSize_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream
        = std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, GetFrameCount_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream
        = std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, GetLatency_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream
        = std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, SetDuckVolume_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream
        = std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, SetRendererWriteCallback_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream
        = std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, SetCapturerReadCallback_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, GetBufferDesc_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream
        = std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, GetBufQueueState_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream
        = std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 * @tc.desc  : Test InitCallbackHandler interface.
 */
HWTEST_F(FastSystemStreamExtUnitTest, InitCallbackHandler_002, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream =
        std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 * @tc.desc  : Test OnHandleData interface.
 */
HWTEST_F(FastSystemStreamExtUnitTest, OnHandleData_002, TestSize.Level1)
{
    std::shared_ptr<AudioRendererWriteCallback> callback = std::make_shared<AudioRendererWriteCallbackTest>();
    AudioStreamParams tempParams = {};
    auto audioStream = IAudioStream::GetRecordStream(IAudioStream::PA_STREAM, tempParams, STREAM_MUSIC, getpid());
 ...
 * @tc.desc  : Test InitCallbackHandler interface.
 */
HWTEST_F(FastSystemStreamExtUnitTest, FetchDeviceForSplitStream_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream =
        std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 * @tc.desc  : Test InitCallbackHandler interface.
 */
HWTEST_F(FastSystemStreamExtUnitTest, RestoreAudioStream_002, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream =
        std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, CheckRestoreStatus_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream =
        std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, SetCallbacksWhenRestore_001, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream =
        std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 * @tc.desc  : Test SetCallbacksWhenRestore interface using unsupported parameters.
 */
HWTEST_F(FastSystemStreamExtUnitTest, SetCallbacksWhenRestore_002, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream =
        std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 */
HWTEST_F(FastSystemStreamExtUnitTest, RestoreAudioStream_003, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream =
        std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 * @tc.desc  : Test RestoreAudioStream interface using unsupported parameters.
 */
HWTEST_F(FastSystemStreamExtUnitTest, RestoreAudioStream_004, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream =
        std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 * @tc.desc  : Test RestoreAudioStream interface using unsupported parameters.
 */
HWTEST_F(FastSystemStreamExtUnitTest, RestoreAudioStream_005, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream =
        std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 * @tc.desc  : Test RestoreAudioStream interface using unsupported parameters.
 */
HWTEST_F(FastSystemStreamExtUnitTest, RestoreAudioStream_006, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream =
        std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 * @tc.desc  : Test RestoreAudioStream interface using unsupported parameters.
 */
HWTEST_F(FastSystemStreamExtUnitTest, RestoreAudioStream_007, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream =
        std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
 ...
 * @tc.desc  : Test RestoreAudioStream interface using unsupported parameters.
 */
HWTEST_F(FastSystemStreamExtUnitTest, RestoreAudioStream_008, TestSize.Level1)
{
    int32_t appUid = static_cast<int32_t>(getuid());
    std::shared_ptr<FastAudioStream> fastAudioStream =
        std::make_shared<FastAudioStream>(STREAM_MUSIC, AUDIO_MODE_PLAYBACK, appUid);
