...
OH_AudioSuiteEngine_MultiRenderFrame(audioSuitePipeline[pipelineIndex], &audioDataArray, &responseSize, &finishedFlag);
}
...
void AudioSuiteEngineSetSoundFiledTypeFuzzTest()
{
uint32_t nodeIndex = GetData<uint32_t>() % MAX_NODE_NUM;
OH_SoundFieldType soundFieldType = GetData<OH_SoundFieldType>();
OH_AudioSuiteEngine_SetSoundFiledType(audioNode[nodeIndex], soundFieldType);
}
...
void AudioSuiteEngineGetSoundFiledTypeFuzzTest()
{
uint32_t nodeIndex = GetData<uint32_t>() % MAX_NODE_NUM;
OH_SoundFieldType soundFieldType;
OH_AudioSuiteEngine_GetSoundFiledType(audioNode[nodeIndex], &soundFieldType);
}
...
AudioSuiteEngineSetSoundFiledTypeFuzzTest,
...
AudioSuiteEngineGetSoundFiledTypeFuzzTest,
